...
export default function BossInfo() {
  ...
  return (
    ...
    //       <p>
    //         Hideous Scarkrill is the second boss of Demon Beast Canyon. It's
    //         more agile than the first boss and enters a stealth mode a few
    //         minutes after the initial encounter. To remove the stealth you need
    //         to work as a team and force the boss to teleport to specific
    //         locations.
    //       </p>
    //       <h2>Special Attack Patterns and Mechanics</h2>
    ...
    //         boss fight. While in this mode the boss takes reduced damage and
    //         only does teleport and spin attacks. At the same time, one orb
    //         spawns at the edge of the battleground in each cardinal direction.
    //         The only way to force the boss back to normal mode is to make him
    //         teleport close to each of the orbs and do the spin attack. When
    //         successful, the boss will destroy the orb with a spin attack and
    //         make it explode. This explosion staggers the boss for a few seconds.
    //         Use this opportunity to run as a team either clockwise or
    //         counterclockwise to the next orb. Scarkrill returns to normal mode
    //         once all 4 orb explosions hit the boss. Be aware that the spin
    //         attack of the boss and the orb explosion combined deal a decent
    //         amount of damage to the player on hit. To prevent this from
    //         happening, move or dodge immediately towards the next orb as soon as
    //         the boss teleports to the orb next to you.
    //       </p>
    //       <div class="break"></div>
    //       <br />
    //       <h2>Guide Video</h2>
